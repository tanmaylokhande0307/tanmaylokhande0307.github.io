      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">What makes this Workshop so special</h2>
            <p className="text-xl text-gray-400">
              100 hours of content is zipped into this 3-hour session to save
              your time and take action on upskilling.
            </p>
          </div>
          ...
          >
            ...
            >
              ...
              <p className="text-lg text-gray-400 text-center">
                Know the specific use cases, advantages, and constraints of some
            ...
            >
              ...
              <p className="text-lg text-gray-400 text-center">
                Learn the art and science of prompting and what makes a prompt
                perfect
              </p>
            </div>
            ...
            >
              ...
              <p className="text-lg text-gray-400 text-center">
                Learn the Magic Prompt formula to always get the best output
                from ChatGPT
              </p>
            </div>
            ...
            >
              ...
              <p className="text-lg text-gray-400 text-center">
              Bonus tools, tips and tricks for selective attendees              </p>
            </div>
            <div
              className="relative flex flex-col items-center"
              data-aos="fade-up"
            ...
            >
              ...
              <p className="text-lg text-gray-400 text-center">
              Develop an understanding of how to leverage AI in your specific professional              </p>
            </div>
            <div
              className="relative flex flex-col items-center"
              data-aos="fade-up"
            ...
            >
              ...
              <p className="text-lg text-gray-400 text-center">
              Learn about some of the most useful AI tools and extensions              </p>
            </div>
          </div>
        </div>
      </div>
